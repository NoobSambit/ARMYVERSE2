          ...
          {recentPosts.length > 0 ? (
            recentPosts.map(post => (
              <Link
                key={post._id}
                href={`/blogs/${post._id}`}
                className="flex gap-3 sm:gap-4 p-2.5 sm:p-3 rounded-xl hover:bg-secondary/40 transition-colors cursor-pointer group"
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  <span
                    className={`text-[10px] sm:text-xs ${getMoodColor(post.mood)} font-bold`}
                  >
                    {getMoodLabel(post)}
                  </span>
                  <h4 className="text-sm sm:text-base font-bold text-white group-hover:text-primary transition-colors line-clamp-2">
                    {post.title}
                  </h4>
            ...
            <>
              <div className="flex gap-3 sm:gap-4 p-2.5 sm:p-3 rounded-lg sm:rounded-xl hover:bg-secondary/40 transition-colors cursor-pointer group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white group-hover:text-primary transition-colors line-clamp-2">
                    Decoding the metaphors in Rainy Days
                  </h4>
                  <p className="text-[10px] sm:text-xs text-gray-400 mt-0.5 sm:mt-1">
                    2 hours ago
                  </p>
              ...
              <div className="flex gap-3 sm:gap-4 p-2.5 sm:p-3 rounded-lg sm:rounded-xl hover:bg-secondary/40 transition-colors cursor-pointer group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white group-hover:text-primary transition-colors line-clamp-2">
                    How to stream effectively on Stationhead
                  </h4>
                  <p className="text-[10px] sm:text-xs text-gray-400 mt-0.5 sm:mt-1">
                    1 day ago
                  </p>
