...
export default function BentoTierSystem() {
  const tiers = [
    { name: 'Legendary', color: 'bg-accent-green', textColor: 'text-accent-green', drop: '1%', shadow: 'shadow-[0_0_10px_rgba(57,255,20,0.5)]' },
    { name: 'Epic', color: 'bg-primary', textColor: 'text-primary', drop: '7%', shadow: 'shadow-[0_0_10px_rgba(0,240,255,0.5)]' },
    { name: 'Rare', color: 'bg-accent-blue', textColor: 'text-accent-blue', drop: '22%', shadow: 'shadow-[0_0_10px_rgba(0,170,255,0.5)]' },
    { name: 'Common', color: 'bg-gray-600', textColor: 'text-gray-400', drop: '70%', shadow: '' }
  ]
