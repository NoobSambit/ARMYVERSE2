...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[60] bg-[#0F0B1E]/95 backdrop-blur-xl border-t border-white/10 pb-safe lg:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
