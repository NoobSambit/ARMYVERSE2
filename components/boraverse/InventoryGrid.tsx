...
type Item = { id: string; acquiredAt: string; card: { member: string; era: string; set: string; rarity: 'common'|'rare'|'epic'|'legendary' | null | undefined; publicId: string; imageUrl: string } }
